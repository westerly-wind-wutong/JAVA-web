...
<head>
    ...
    <link href="./css/index.css" rel="stylesheet">z
...
<main>
    <div class="main-content">
        ...
        <div class="picbox">
            ...
            <div class="Box_con"><span class="btnl btn" id="btnl"></span> <span class="btnr btn" id="btnr"></span>
                <div class="conbox" id="BoxUl">
                    <ul>
                        <li class="cur"><a href="http://news.baidu.com/"><img src="./images/zhuye.png" alt=""/>
                            <p>百度新闻</p>
                        </a></li>
        ...
        <div class="newsbox">
            <section>
                <div class="news">
                    <h2 class="newstitle"><span><a href="/foot.jsp">更多</a></span><b>最新时事</b></h2>
                    <ul id="cate1">
