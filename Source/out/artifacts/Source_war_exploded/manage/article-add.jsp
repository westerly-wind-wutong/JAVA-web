        ...
        <form class="layui-form" method="post" id="addForm">
            ...
            <div class="layui-form-item">
                ...
                <div>
                 ...
                 <textarea class="layui-textarea" id="txtContext" name="txtContext" style="display: none">内容填写在此处</textarea>

                </div>
            </div>
            <div class="layui-form-item">
                <label for="txtCreatedTime" class="layui-form-label">
                    <span class="x-red">*</span>发布时间
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="txtCreatedTime" name="txtCreatedTime" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="${nowtime}">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    ...
    layui.use(['layedit','upload'], function(){
        ...
        form.on('submit(add)', function (data) {
            ...
            obj.txtCreatedTime=data.field.txtCreatedTime;
            obj.hidImg=data.field.hidImg;
            obj.action="saveArticle";
