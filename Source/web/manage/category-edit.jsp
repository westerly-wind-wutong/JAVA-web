    ...
    <div class="layui-row">
        <form class="layui-form" method="post" id="addForm">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="txtName" name="txtName" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="${category.getName()}">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="txtSort" name="txtSort" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="${category.getSort()}">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" id="hidId" name="hidId"  value="${category.getId()}">
                </div>
            </div>
            <div class="layui-form-item">
